...
public class JeuDuPendu {
    ...
    /**
     * Permet au joueur de proposer une lettre. Si la lettre n'a pas déjà été proposée, l'appel à cette méthode  compte pour un essai.
    ...
    /**
     * @return Les lettres découvertes dans le mot. Les lettres inconnues sont remplacées par -. Par exemple : bo-jo--
     */
	...
	/**
	 * @return Si le joueur a gagné, c'est-à-dire si toutes les lettres ont été découvertes avant d'avoir épuisé le nombre d'essais.
	 */
	...
	/**
	 * @return Si le joueur a perdu, c'est-à-dire s'il ne peut plus faire de proposition.
	 */
